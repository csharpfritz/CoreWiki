...
**NOTE:** This project is the result of some streams transmitted using [TWITCH](https://www.twitch.tv/csharpfritz) platform. To collaborate and understand the project, please see the follows streams:
