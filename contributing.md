...
3. Please submit all pull-requests to the dev branch unless you are working on a formal project, in which case you should submit the pull-request to that proejct-specific branch.
